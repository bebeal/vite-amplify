...
> **Note:** This template uses Berkeley Mono font, which is a paid font. You'll need to purchase a license from <a href="https://usgraphics.com" target="_blank">US Graphics</a> to use it in your project.
