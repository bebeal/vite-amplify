...
> **Note:** This template uses Berkeley Mono font, which is a paid font. You'll need to purchase a license from [US Graphics](https://usgraphics.com) to use it in your project.
